        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
           ...
           // echo '  <li class="nav-item">Welcome, '.$_SESSION["username"].' </li>';
                echo ' <li class="nav-item active">
                          <a class="nav-link" href="user_profile_info.php" data-toggle="tooltip" data-placement="left" title="Profile Info"> <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                                <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                              </svg> Welcome, '.$_SESSION["username"].'
