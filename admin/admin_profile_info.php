...
<?php 
     if(isset($_POST['updateData'])){    
        ...
        $query = mysqli_query($conn, "UPDATE tbl_admin_credentials SET last_name='$last_name', first_name='$first_name', middle_name='$middle_name', 
...
<!-- <button class="btn btn-primary btn-sm " data-toggle="modal" data-target="#addBtn">Update Information</button>             -->
 <?php 
    ...
    <?php  } 
        ...
        $infoUser = mysqli_query($conn, "SELECT * from tbl_admin_credentials where username = '$username_session'");
